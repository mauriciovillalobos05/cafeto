...
const links = [
  { name: 'Whatsapp', href: 'https://wa.me/3322038129', icon: '/wp.png' },
  ...
  { name: 'Mail', href: 'mailto:ventasenlinea@pasioncafeto.com', icon: '/correo.png' },
];

export default function PedidosLinks() {
  return (
    <>
      {links.map((link) => (
        <a
